// UnderWater.cpp : 애플리케이션에 대한 진입점을 정의합니다.
//
    ...
    _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_UnderWater, szWindowClass, MAX_LOADSTRING);
    ...
    // 단축키 정보
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_UnderWater));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_UnderWater));   // 프로그램 아이콘
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   SetWindowPos(hWnd, NULL, 640, 479, (rc.right - rc.left), (rc.bottom - rc.top), SWP_NOZORDER | SWP_NOMOVE);
